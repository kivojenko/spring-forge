...
import com.kivojenko.spring.forge.jpa.model.relation.manyToMany.RemoveManyToManyEndpointRelation;
...
import com.kivojenko.spring.forge.jpa.model.relation.oneToOne.RemoveOneToOneEndpointRelation;
...
public class EndpointRelationFactory {
  ...
  private static @NonNull List<EndpointRelation> resolveFieldEndpointRelation(
    ...
    if (manyToOne != null || embedded != null || oneToOne != null) {
    ...
    if (withEndpoints.remove()) {
      if (embedded != null || oneToOne != null) {
        result.add(RemoveOneToOneEndpointRelation
            .builder()
            .path(path)
            .field(field)
            .methodName(methodName)
      ...
      if (manyToMany != null) {
        result.add(RemoveManyToManyEndpointRelation
            .builder()
            .path(path)
            .field(field)
            .methodName(methodName)
   ...
   */
  private static TypeElement getElementTypeFromList(TypeMirror returnType, Element element, ProcessingEnvironment env) {
